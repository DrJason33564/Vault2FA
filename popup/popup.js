...
const STATIC_TEXT_MAP = {
  ...
  autofillEnableText: 'autofillEnableText', autofillEnableHint: 'autofillEnableHint', rightclickEnableText: 'rightclickEnableText', rightclickEnableHint: 'rightclickEnableHint',
...
function applyStaticTranslations(){
  ...
  const popupFallbackText = {
    ...
    autofillEnableText: 'Enable autofill feature',
    autofillEnableHint: 'Automatically inject autofill on matched websites.',
    rightclickEnableText: 'Enable right-click QR scan option',
    rightclickEnableHint: 'Show a QR scanning action in the browser image context menu.',
